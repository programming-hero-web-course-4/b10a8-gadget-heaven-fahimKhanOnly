                    ...
                    <div className="container  flex gap-6 bg-white text-black p-6 absolute rounded-2xl">
                        ...
                        <div className="flex flex-col items-baseline justify-between">
                            ...
                            <div className="flex gap-4 mt-3">
                                ...
                                <button disabled={productId.includes(product_id)} onClick={() => handleWishlist(findRealData, product_id)} className="btn btn-outline rounded-full hover:bg-purple-700 hover:border-none hover:text-white"><FaRegHeart/></button>
                            </div>
                        </div>
                    </div>
                </div>
